...
- [GitHub Repository](https://github.com/jakerood/datafun-06-projects)

In this module we perform a guided exploratory data analysis project using the Diamonds CSV file.
We also conduct a unique data analysis exploration relating to our domain, baseball.
